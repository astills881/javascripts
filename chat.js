...
var ajaxChat = {
		...
		if(this.settings['audio'] && this.sounds && this.lastID && !this.channelSwitch) {
			switch(userID) {
				...
				case this.userID:
					...
					break;
				default:
                    if(messageText.indexOf('.alert') !== -1) {
                        if(parseInt(channelID) === 1) {
                            this.playSound(this.settings['soundAlert']);
                        }
                        break;
                    }
                    if(messageText.indexOf('.tip') !== -1) {
                        if(parseInt(channelID) === 1) {
                            this.playSound(this.settings['soundHorse']);
                        }
                        break;
                    }
                    if(messageText.indexOf('.bear') !== -1) {
                        if(parseInt(channelID) === 1) {
                            this.playSound(this.settings['soundBear']);
                        }
                        break;
                    }
                    if(messageText.indexOf('.toilet') !== -1) {
                        if(parseInt(channelID) === 1) {
                            this.playSound(this.settings['soundToilet']);
                        }
                        break;
                    }
	...
	setFontBold: function() {
			if(FontBold) {
				this.dom['inputField'].style.fontWeight="normal";
				document.getElementById("fsb").style.fontWeight="normal";
			} else {
				this.dom['inputField'].style.fontWeight="bold";
				document.getElementById("fsb").style.fontWeight="bold";
			}
			FontBold = !FontBold;
			this.dom['inputField'].focus();
	},	
	...
	setFontItalic: function() {
			if(FontItalic) {
				this.dom['inputField'].style.fontStyle="normal";
				document.getElementById("fsi").style.fontStyle="normal";
			} else {
				this.dom['inputField'].style.fontStyle="italic";
				document.getElementById("fsi").style.fontStyle="italic";
			}
	...
	setFontUnderline: function() {
			if(FontUnderline) {
				this.dom['inputField'].style.textDecoration ="none";
				document.getElementById("fsu").style.textDecoration="none";
			} else {
				this.dom['inputField'].style.textDecoration ="underline";
				document.getElementById("fsu").style.textDecoration="underline";
			}
	...
	replaceCustomText: function(text) {
        if(text.indexOf('.alert') !== -1 || text.indexOf('.tip') !== -1 || text.indexOf('.bear') !== -1 || text.indexOf('.toilet') !== -1) {
            text = '';
        }
		return text;
	},
